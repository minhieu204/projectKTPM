        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a onclick="return confirm('Bạn có muốn xóa slider không?');" href="index.php?controller=slider&action=delete&id=<?php echo $value['id']; ?>"><button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Xóa</button></a>
                    </td>
                </tr>
                <?php
                    $stt++;
